...
class DomainConverter:
    def __init__(self):
        ...
        # Auto-synced blocklist files (generated by scripts/)
        self.synced_blacklists = [
            "./lists/bytedance_blocklist.txt"
        ]
    ...
    def process_urls(self):
        ...
        # Read auto-synced blocklist files
        for synced_file in self.synced_blacklists:
